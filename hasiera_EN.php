...
<body>
    ...
    <div class="imagenes">
        <div class="imagen" id="imagen1">
            <a href="katalogoaOrdenagailuak_EN.php" class="irudiak">
        ...
        <div class="imagen" id="imagen2">
            <a href="katalogoaMugikorrak_EN.php" class="irudiak">
        ...
        <div class="imagen" id="imagen3">
            <a href="katalogoaMonitoreak_EN.php" class="irudiak">
        ...
        <div class="imagen" id="imagen4">
            <a href="katalogoaAurikularrak_EN.php" class="irudiak">
